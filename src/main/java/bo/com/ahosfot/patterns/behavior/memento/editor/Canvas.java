...
import bo.com.ahosfot.patterns.behavior.memento.commands.ColorCommand;
import bo.com.ahosfot.patterns.behavior.memento.commands.MoveCommand;
...
public class Canvas extends java.awt.Canvas {
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                Shape target = editor.getAllShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
    ...
    public int getWidth() {
        return editor.getAllShapes().getX() + editor.getAllShapes().getWidth() + PADDING;
    }

    public int getHeight() {
        return editor.getAllShapes().getY() + editor.getAllShapes().getHeight() + PADDING;
    }
    ...
    public void paint(Graphics graphics) {
        ...
        editor.getAllShapes().paint(buffer.getGraphics());
